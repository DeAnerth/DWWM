    ...
    <section class="mt-5 mb-5">
        <article>
            ...
            <div class="btnArticlePageContainer">
                <div class="phoneArticlePageContainer mb-3 mt-3">
                    <a href="<?= isset($readArticle->phone) ? $readArticle->phone : '' ?>" target="_blanck" class="btn btn-bkgd-black text-white-yellow-btn col-md-12">Contactez le <?= $readArticle->phone ?> pour joindre l'établissement</a>
                </div>
                <div class="websiteArticlePageContainer mb-3 mt-3">
                    <a href="<?= isset($readArticle->website) ? $readArticle->website : '' ?>" target="_blanck" class="btn btn-bkgd-black text-white-yellow-btn col-md-12">Se rendre sur le site internet de l'établissement</a>
                </div>
                <div class="mb-3 mt-3">
